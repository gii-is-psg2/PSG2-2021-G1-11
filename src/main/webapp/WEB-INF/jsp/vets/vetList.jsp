...
<petclinic:layout pageName="vets">
	...
	<a class="btn btn-default" href="${fn:escapeXml(vetUrl)}"><fmt:message
			key="addVet" /></a>
	<br>
	<br>
				...
				<tr>
					...
					<td>
						<div style="display: flex;">
							...
							<a href="${fn:escapeXml(vetUrl)}" class="btn btn-default"><fmt:message
									key="editVet" /></a>
							<c:if test="${canRemoveVets}">
								<form:form method="POST" action="vets/${vet.id}/remove">
									<button class="btn btn-default" type="submit"
										style="margin-left: 20px;">
										<fmt:message key="remVet" />
									</button>
								</form:form>
							</c:if>
						</div>
