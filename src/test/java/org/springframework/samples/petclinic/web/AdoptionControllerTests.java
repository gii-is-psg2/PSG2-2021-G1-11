...
@WebMvcTest(value = AdoptionController.class, includeFilters = @ComponentScan.Filter(value = PetTypeFormatter.class, type = FilterType.ASSIGNABLE_TYPE),
...
public class AdoptionControllerTests {
	...
	void setup() {
		...
		BDDMockito.given(this.petService.findPetById(AdoptionControllerTests.PET_ADOPTABLE_ID)).willReturn(adoptablePet);
		BDDMockito.given(this.petService.findPetById(AdoptionControllerTests.PET_NOT_ADOPTABLE_ID)).willReturn(new Pet());
	...
	void testObtainPendingApplications() throws Exception {
		BDDMockito.given(this.ownerService.getOwnerByUserName(AdoptionControllerTests.TEST_OWNER_NAME)).willReturn(this.owner);
	...
	void testAcceptAdoptionApplication() throws Exception {
		BDDMockito.given(this.adoptionApplicationService.findById(AdoptionControllerTests.APPLICATION_ID)).willReturn(this.adoptionApplication);
		BDDMockito.given(this.ownerService.getOwnerByUserName("owner")).willReturn(this.owner);

		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/{applications_id}/accept", AdoptionControllerTests.APPLICATION_ID)).andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.redirectedUrl("/adoptions/applications"));
	...
	void testDeclineAdoptionApplication() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/{applications_id}/decline", AdoptionControllerTests.APPLICATION_ID)).andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.redirectedUrl("/adoptions/applications"));

		Mockito.verify(this.adoptionApplicationService, Mockito.times(1)).declineAdoptionApplication(AdoptionControllerTests.APPLICATION_ID);
	}
	...
	void testNotDeclineApplicationBecauseOfIncorrectPrincipal() throws Exception {
		...
		Mockito.verify(this.adoptionApplicationService, Mockito.times(0)).declineAdoptionApplication(AdoptionControllerTests.APPLICATION_ID);
	}

	@WithMockUser(value = "spring")
	@Test
	void testInitAdoptionApplicationForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/pets/{petId}/apply", AdoptionControllerTests.PET_ADOPTABLE_ID)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name(AdoptionControllerTests.VIEW_CREATE_ADOPTION_APPLICATION));
	}

	@WithMockUser(value = "spring")
	@Test
	void testInitNotAdoptableApplicationForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/pets/{petId}/apply", AdoptionControllerTests.PET_NOT_ADOPTABLE_ID)).andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.redirectedUrl("/"));
	}
	...
	void testCreateAdoptionApplicationNoDescription() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/pets/{petId}/apply", AdoptionControllerTests.PET_ADOPTABLE_ID).with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "         ")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("adoptions/createAdoptionApplication")).andExpect(MockMvcResultMatchers.model().hasErrors());
	}
	...
	void testCreateAdoptionApplicationNotAdoptablePet() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/pets/{petId}/apply", AdoptionControllerTests.PET_NOT_ADOPTABLE_ID).with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "Hey! I want to take care of your pet!")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("adoptions/createAdoptionApplication"))
			.andExpect(MockMvcResultMatchers.model().hasErrors());
	}
	...
	void testCreateAdoptionApplicationAlreadySent() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/pets/{petId}/apply", AdoptionControllerTests.PET_ADOPTABLE_ID).with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "Hey! I want to take care of your pet again!")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("adoptions/createAdoptionApplication"))
			.andExpect(MockMvcResultMatchers.model().hasErrors());
	}
	...
	void testInAdoptionList() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/pets")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("pets"))
